...
*/
        ...
        graos = b.getParcelableArrayList("graos");
        int idGrao = (int)b.get("siloGraoID");
        for(Grao grao : graos)
        {
            if(grao.getGraoID() == (idGrao))
            {
                BeaconAdapter beaconadapter = new BeaconAdapter(beacons, grao.getGraoTempMax(), getApplication());
